...
document.querySelector(".self").innerHTML += SelfUI("./Imgs/mug.png","./Imgs/mug_DIY.png","Use an old mug as a container for stationery");
document.querySelector(".self").innerHTML += SelfUI("./Imgs/magazine.png","./Imgs/paper_DIY.png","Using magazines and extra paper for arts and crafts");